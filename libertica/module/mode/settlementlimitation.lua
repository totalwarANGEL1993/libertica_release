...
function Lib.SettlementSurvival.Global:IsTypeAllowedByListing(_Type, _TerritoryID)
...
function Lib.SettlementSurvival.Local:IsTypeAllowedByListing(_Type, _TerritoryID)
